...
const SpotCard = ({ spot, onPress }) => (
  <TouchableOpacity onPress={onPress} style={styles.card}>
    <View style={styles.infoContainer}>
      ...
      <Text style={styles.details}>Wave: {spot.forecast.waveHeight}m | Wind: {spot.forecast.wind.speed} kph</Text>
    </View>
...
const styles = StyleSheet.create({
  card: { flexDirection: 'row', backgroundColor: 'white', padding: 15, marginVertical: 8, marginHorizontal: 10, borderRadius: 10, shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.1, shadowRadius: 4, elevation: 3 },
